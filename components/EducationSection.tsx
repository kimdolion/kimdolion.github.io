...
export const EducationSection = ({extraInfo=false}: EducationProps): JSX.Element => (
  <>
    <section>
        ...
        <div>
          <InlineHeading id="education-1" mainHeadingText='Bunker Hill Community College' startYear={2019} endYear={2021} url="https://www.bhcc.edu/" />
          <p>Coursework in Computer Science</p>
          {extraInfo ? <p>Coursework included Java, C++, SQL, and Data Structures</p> : null}
        </div>
        <div>
          <InlineHeading id="education-2" mainHeadingText='University of Massachusetts Boston' startYear={2013} endYear={2014} url="https://www.umb.edu/" />
        ...
        <div>
          <InlineHeading id="education-3" mainHeadingText='Amherst College' startYear={2009} endYear={2013} includeURL url="https://www.amherst.edu/" />
