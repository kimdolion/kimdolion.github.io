  ...
  <>
    <section className='styled-section'>
      <div className="column">
        <Image src={profilePhoto} alt="Profile photo of Kimberly Wilkes." height={220} width={145} />
      </div>
      <div>
        <Link href="/about"><h2 id="about-section">About Kimberly</h2></Link>
        <div>
          <h3>Hello!</h3>
          <Image src={korAmFlag} height={50} width={50} alt={"Korean American blended flag."} />
