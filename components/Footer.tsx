...
export const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{ boxShadow: `0 1px 30px -10px ${isDarkMode ? "black" : "gray"}` }}
    >
      <div
        style={{
          alignItems: "center",
      ...
      >
        ...
        <StyledLink
          ...
          leftIcon
        >
          <LinkedInIcon fill={isDarkMode ? "white" : ""} width="1.75em" />
        </StyledLink>
      </div>
      <div className={styles.footerAttributes}>
        <div className={styles.footerAttributes} style={{ gap: 20 }}>
          <StyledLink
            ...
            name="Designed & Built by Kimberly Wilkes"
          />
          <StyledLink
            href="https://www.carbon-fibre.me/patriot"
            name="Korean and US Flag by Onjena Yo"
          />
        </div>
        <Link
        ...
        >
          Powered by{" "}
          <Image src={vercel} alt="Vercel Logo." height={75} width={75} />
        </Link>
      </div>
    </footer>
  );
